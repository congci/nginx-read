...
struct ngx_listening_s {
    ...
    struct sockaddr    *sockaddr;//套接字地址 ip 端口
    ...
    ngx_connection_handler_pt   handler//一般是event的函数
...
struct ngx_connection_s {
    ...
    struct sockaddr    *sockaddr; //socket的结构
    socklen_t           socklen;
    ngx_str_t           addr_text;
    ...
    socklen_t           local_socklen;//长度

    ngx_buf_t          *buffer;//buf
