...
ngx_http_init_phase_handlers(ngx_conf_t *cf, ngx_http_core_main_conf_t *cmcf)
{
    ...
    for (i = 0; i < NGX_HTTP_LOG_PHASE; i++) { //10
    ...
    for (i = 0; i < NGX_HTTP_LOG_PHASE; i++) {
        ...
        //上面有continue的走不到这步、也就是说NGX_HTTP_FIND_CONFIG_PHASE、NGX_HTTP_POST_REWRITE_PHASE、NGX_HTTP_POST_ACCESS_PHASE、NGX_HTTP_TRY_FILES_PHASE不能注册模块
